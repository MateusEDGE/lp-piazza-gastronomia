# lp-piazza-gastronomia

Landing page de tráfego pago do Piazza Nicomedes — hub de gastronomia.
...
dentro do site, em `nexamalls.com.br/empreendimentos/piazza-nicomedes/lojista/gastronomia`:
